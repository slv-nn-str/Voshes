                        ...
                        <div class="col-lg-4">
                            <form method="post" action="../upload_profile.php" enctype="multipart/form-data">
                                <div class="card mb-3">
                                    ...
                                    <input type="submit" id="submit_pic" name="submit_pic" class="btn btn-primary">
                                </div>
                            </form>
                        </div>
                        <div class="col-lg-8">
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body" style="padding-top: 0px;">
                                            <form action="../password_process.php" method="post">
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="username"><strong>Username</strong></label><input class="form-control" type="text" id="username" placeholder="user.name" name="username" value="<?php echo $_SESSION['user_id']?>" disabled=""></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="email"><strong>Email Address</strong></label><input class="form-control" type="email" id="email" placeholder="user@example.com" name="email" value="<?php echo $_SESSION['email'];?>" disabled></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="first_name"><strong>First Name</strong></label><input class="form-control" type="text" id="first_name" placeholder="John" name="first_name" value="<?php echo $_SESSION['fname'];?>" disabled=""></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="last_name"><strong>Last Name</strong></label><input class="form-control" type="text" id="last_name" placeholder="Doe" name="last_name" value="<?php echo $_SESSION['lname'];?>" disabled=""></div>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                    ...
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <form action="../password_process.php" method="post">
                                                ...
                                                <div class="form-group"><input type="submit" name="student_pass" value="Save Settings" class="btn btn-primary"></div>
                                            </form>
                                        </div>
                                    </div>
                                </div>
