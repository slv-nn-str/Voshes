<?php
	...
	if (isset($_POST['submit'])) {
		...
		$query = "insert into user_events(user_ID,event_name,description,date) 
				  value('".mysqli_real_escape_string($con, $user_ID)."','".mysqli_real_escape_string($con, $event_name)."','".mysqli_real_escape_string($con, $description)."','$event_date')";
	...
	function success(){
		Swal.fire(
		  ...
		  'success'
			...
			window.location.replace('admin-calendar.php');
		});
	}
