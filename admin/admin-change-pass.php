                        ...
                        <div class="col-lg-4">
                            <form method="post" action="../upload_profile.php" enctype="multipart/form-data">
                                <div class="card mb-3">
                                    ...
                                    <input type="submit" id="submit_pic" name="admin_pic" class="btn btn-primary">
                                </div>
                            </form>
                        </div>
                        <div class="col-lg-8">
                                    ...
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <form action="../password_process.php" method="post">
                                                ...
                                                <div class="form-group"><input type="submit" name="admin_pass" value="Save Settings" class="btn btn-primary"></div>
                                            </form>
                                        </div>
                                    </div>
                                </div>
