...
?>
                ...
                <div class="row" style="margin-left: 0px;margin-right: 0px;padding-top: 7px;">
                    <div class="col" style="padding-right: 0px;padding-left: 20px;">
                        <form action="dean-calendar.php" method="post">
                           <?php
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="background: #fbfafa;color: rgb(0,0,0);">
                            <div class="form-group">
                                <h6 style="color: rgb(234,14,0);margin-bottom: 3px;">Event Title:</h6><input class="form-control" type="text" placeholder="Enter Name" style="width: 100%;height: 27px;border-color: rgba(171,144,144,0.11);background: rgb(242,234,234);border-radius: 10px;color: rgb(0,0,0);margin-bottom: 14px;" required="" minlength="2" name="event_name" required="">
                            </div>
                            <div class="form-group">
                                <h6 style="color: rgb(234,14,0);margin-bottom: 3px;">Date :</h6><input class="form-control" type="date" style="border-color: rgba(171,144,144,0.11);background: rgb(242,234,234);border-radius: 10px;color: rgb(4,4,4);" name="event_date" required="">
                            </div>
                            
                            <div class="form-group">
                                <h6 style="color: rgb(234,14,0);margin-bottom: 3px;">Description:</h6><input class="form-control" type="text" style="color: rgb(4,4,4);background: rgb(242,234,234);border-radius: 10px;height: 120px;" placeholder="Event Description" name="description">
                            </div>
                        </div>
